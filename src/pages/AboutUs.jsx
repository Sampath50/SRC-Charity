  ...
  return (
    <div>
      ...
      <div style={{ 
        ...
        color: "white", 
        padding: "25px 20px",  // Reduced from 35px to 25px
        textAlign: "center",
        borderBottom: "4px solid #c0392b"  // Optional: adds a darker border at bottom
      }}>
        <h1 style={{ 
          fontSize: "30px",  // Reduced from 36px
        ...
        <p style={{ 
          ...
          margin: "0 auto",
          opacity: "0.95"
        }}>Making a difference since 2010</p>
      </div>
